...
public class DealerFragment extends Fragment implements RecyclerView.OnScrollChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvDealer = view.findViewById(R.id.rvdealer);
        layoutManager = new GridLayoutManager(getContext(), 1);
        rvDealer.setLayoutManager(layoutManager);
        views = new Views();

        hitApi();

        rvDealer.setOnScrollChangeListener(this);
        //initializing our adapter
        adapter = new DealerAdapter(getActivity(), listData2);
    ...
    private void hitApi() {
        ...
        call = api.hitAllApi(Url.key, String.valueOf(currentPage), "2", "Dealer Purchase");
    ...
    public void onScrollChange(View view, int i, int i1, int i2, int i3) {
        if (isLastItemDisplaying(rvDealer)) {
    ...
    public class DealerAdapter extends RecyclerView.Adapter<DealerAdapter.TotalHolder> {

        Context context;
        ArrayList<AllListDatum> list;
        Views views = new Views();

        public DealerAdapter(Context context, ArrayList<AllListDatum> list) {
        ...
        @NonNull
        @Override
        public DealerAdapter.TotalHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(context).inflate(R.layout.row_all, parent, false);
            return new DealerAdapter.TotalHolder(view);

        }

        @Override
        public void onBindViewHolder(@NonNull final DealerAdapter.TotalHolder holder, int position) {
