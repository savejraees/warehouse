...
public class ShopFragment extends Fragment implements RecyclerView.OnScrollChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvShop.setOnScrollChangeListener(this);
        //initializing our adapter
        adapter = new ShopAdapter(getActivity(), listData2);
    ...
    private void hitApi() {
        ...
        call = api.hitAllApi(Url.key, String.valueOf(currentPage), "3", "Shop Purchase");
    ...
    public void onScrollChange(View view, int i, int i1, int i2, int i3) {
        if (isLastItemDisplaying(rvShop)) {
    ...
    public class ShopAdapter extends RecyclerView.Adapter<ShopAdapter.TotalHolder> {

        Context context;
        ArrayList<AllListDatum> list;
        Views views = new Views();

        public ShopAdapter(Context context, ArrayList<AllListDatum> list) {
        ...
        @NonNull
        @Override
        public ShopAdapter.TotalHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(context).inflate(R.layout.row_all, parent, false);
            return new ShopAdapter.TotalHolder(view);

        }

        @Override
        public void onBindViewHolder(@NonNull final ShopAdapter.TotalHolder holder, int position) {
